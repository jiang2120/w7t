...
<h5 class='title'>微信跳转淘宝，不用复制淘口令点击打开淘宝链接</h5>
<form method='POST' action='/shorten' role='form'>
    <input type='url' autocomplete='off'
        class='form-control long-link-input' placeholder='输入淘宝/天猫店铺首页或商品详情页链接' name='link-url' />
    ...
    <input type='submit' class='btn btn-info' id='shorten' value='生成微信跳转链接' />

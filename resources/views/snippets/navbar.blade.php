<div class="container-fluid">
    <nav role="navigation" class="navbar navbar-default navbar-fixed-top">
        ...
        <ul id="navbar" class="nav navbar-collapse collapse navbar-nav" id="nbc">
		    <li><a href="{{ route('about') }}">使用说明</a></li>
            ...
            @if (empty(session('username')))
                ...
                @endif
            @else
                <li class="visible-xs"><a href="{{ route('admin') }}">链接管理</a></li>
        ...
        <ul id="navbar" class="nav pull-right navbar-nav hidden-xs">
            ...
            @else
                <div class='nav pull-right navbar-nav'>
                    <li class='dropdown'>
                    <a class="dropdown-toggle login-name" href="#" data-toggle="dropdown">{{session('username')}}  用户中心 <strong class="caret"></strong></a>
                        <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu">
                            <li><a tabindex="-1" href="{{ route('admin') }}#links">链接管理</a></li>
